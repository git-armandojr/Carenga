(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["src-app-secure-secure-module"],{
...
module.exports = "<div class=\"form-group search-bar-container\">\n  <input placeholder=\"Procure um endereço\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"off\" type=\"text\" class=\"form-control\" #search [formControl]=\"searchControl\">\n</div>\n<agm-map [latitude]=\"person.lat\" [zoom]=\"zoom\" [longitude]=\"person.lng\" (mapClick)=\"mapClick($event)\">\n  <agm-marker [latitude]=\"person.lat\" [longitude]=\"person.lng\"></agm-marker>\n  <agm-marker *ngFor=\"let match of person.matches\" [latitude]=\"match.lat\" [longitude]=\"match.lng\" [label]=\"match.name\"></agm-marker>\n</agm-map>\n<a id=\"fab-save\" class=\"btn-floating btn-large waves-effect waves-light\" (click)=\"savePerson(person)\"><i class=\"material-icons\">save</i></a>"

/***/ }),

/***/ "./src/app/secure/map/map.component.scss":
/*!***********************************************!*\
  !*** ./src/app/secure/map/map.component.scss ***!
  \***********************************************/
/*! no static exports found */
...
module.exports = ".search-bar-container {\n  padding: 0 0.5em;\n  position: absolute;\n  top: 64px;\n  left: 0;\n  z-index: 99;\n  width: 100%;\n  color: white; }\n  .search-bar-container input {\n    opacity: 0.7;\n    background: white; }\n  agm-map {\n  width: 99vw;\n  height: calc(100vh - 64px); }\n  #fab-save {\n  position: absolute;\n  bottom: 4px;\n  left: 4px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/secure/map/map.component.ts":
/*!*********************************************!*\
  !*** ./src/app/secure/map/map.component.ts ***!
  \*********************************************/
...
/* harmony import */ var _providers_account_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../providers/account.service */ "./src/app/secure/providers/account.service.ts");
...
var MapComponent = /** @class */ (function () {
    function MapComponent(provider, mapsAPILoader, ngZone) {
                        ...
                        this.mapsAPILoader.load().then(function () {
                            ...
                            autocomplete.addListener("place_changed", function () {
                                _this.ngZone.run(function () {
                                    ...
                                    _this.person.lat = place.geometry.location.lat();
                                    _this.person.lng = place.geometry.location.lng();
                                    _this.person.address = _this.searchElementRef.nativeElement.value;
                                    _this.zoom = 15;
                                });
                            });
                        });
                        _a = this;
                        return [4 /*yield*/, this.provider.getAccount()];
                    case 1:
                        _a.person = _b.sent();
                        ...
                        if (!this.person.lat || !this.person.lng)
                            navigator.geolocation.getCurrentPosition(function (pos) {
                                _this.person.lng = +pos.coords.longitude;
                                _this.person.lat = +pos.coords.latitude;
                            });
                        return [2 /*return*/];
                }
            });
    ...
    MapComponent.prototype.savePerson = function (person) {
        console.log('save person', person);
        this.provider.updateAccount(person)
            .then(function () { return materialize_css__WEBPACK_IMPORTED_MODULE_5__["toast"]({ html: 'Endereço salvo com sucesso!' }); });
    };
    ...
    MapComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-map',
            template: __webpack_require__(/*! ./map.component.html */ "./src/app/secure/map/map.component.html"),
            styles: [__webpack_require__(/*! ./map.component.scss */ "./src/app/secure/map/map.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_providers_account_service__WEBPACK_IMPORTED_MODULE_4__["AccountService"], _agm_core__WEBPACK_IMPORTED_MODULE_3__["MapsAPILoader"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]])
    ], MapComponent);
    return MapComponent;
}());
...
/***/ "./src/app/secure/providers/account.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/secure/providers/account.service.ts ***!
  \*****************************************************/
...
var AccountService = /** @class */ (function () {
    ...
    AccountService.prototype.updateAccount = function (item) {
        return this.http.post('/api/account/update', item, this.getHeaders())
            .toPromise();
    };
    AccountService.prototype.deleteAccount = function (item) {
...
/***/ "./src/app/secure/ride/ride.component.html":
/*!*************************************************!*\
  !*** ./src/app/secure/ride/ride.component.html ***!
  \*************************************************/
/*! no static exports found */
...
module.exports = "<div>\n  <h4>Caronas Cadastradas ({{ person.type }})</h4>\n  <table class=\"highlight centered\">\n    <thead>\n      <tr>\n        <td>Nome</td>\n        <td>e-mail</td>\n        <td>Endereço</td>\n        <td></td>\n      </tr>\n    </thead>\n    <tbody>\n      <tr *ngFor=\"let match of person.matches\">\n        <td>{{ match.name }}</td>\n        <td>{{ match.mail }}</td>\n        <td>{{ match.address }}</td>\n        <td>\n          <a class=\"waves-effect waves-light red-text\" (click)=\"removeMatch(match)\"><i class=\"material-icons\">delete_forever</i></a>\n        </td>\n      </tr>\n    </tbody>\n  </table>\n\n  <h6 *ngIf=\"!person.matches || !person.matches.length\" id=\"no-items\"><i>Nenhum Item cadastrado</i></h6>\n\n  <br/>\n\n  <h5>Caronas Solicitadas</h5>\n  <table class=\"highlight centered\">\n    <thead>\n      <tr>\n        <td>Nome</td>\n        <td>e-mail</td>\n        <td>Endereço</td>\n        <td></td>\n      </tr>\n    </thead>\n    <tbody>\n      <tr *ngFor=\"let invite of person.invites\">\n        <td>{{ invite.name }}</td>\n        <td>{{ invite.mail }}</td>\n        <td>{{ invite.address }}</td>\n        <td>\n          <a class=\"waves-effect waves-light red-text\" (click)=\"removeInvite(invite)\"><i class=\"material-icons\">delete_forever</i></a>\n        </td>\n      </tr>\n    </tbody>\n  </table>\n\n  <h6  *ngIf=\"!person.invites || !person.invites.length\" id=\"no-items\"><i>Nenhum Item cadastrado</i></h6>\n\n  <br/>\n  <br/>\n  <br/>\n\n  <button class=\"btn waves-effect waves-light\" id=\"search-button\" type=\"button\" (click)=\"nextCandidate()\" [disabled]=\"!person.lat || !person.lng\">\n    <span>Procurar caronas</span>\n    <i class=\"material-icons right\">search</i>\n  </button>\n</div>\n\n<div class=\"modal\">\n  <div class=\"modal-content\">\n    <h4>{{ currentPerson.firstName }} {{ currentPerson.lastName }}</h4>\n    <agm-map [latitude]=\"currentPerson.lat\" [longitude]=\"currentPerson.lng\" [zoom]=\"12\">\n        <agm-marker [latitude]=\"person.lat\" [longitude]=\"person.lng\"></agm-marker>\n        <agm-marker [latitude]=\"currentPerson.lat+0.01\" [longitude]=\"currentPerson.lng\" [label]=\"currentPerson.firstName\"></agm-marker>\n    </agm-map>\n    <p>{{ currentPerson.address }}</p>\n  </div>\n  <div class=\"modal-footer\">\n    <a class=\"btn-floating btn-large waves-effect waves-light red\" style=\"float:left\" (click)=\"refuse(currentPerson)\"><i class=\"material-icons\">close</i></a>\n    <a class=\"btn-floating btn-large waves-effect waves-light green\" (click)=\"accept(currentPerson)\"><i class=\"material-icons\">done</i></a>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/secure/ride/ride.component.scss":
/*!*************************************************!*\
  !*** ./src/app/secure/ride/ride.component.scss ***!
  \*************************************************/
/*! no static exports found */
...
module.exports = "agm-map {\n  height: 200px; }\n\n#no-items {\n  margin: 2em;\n  display: block;\n  text-align: center; }\n\n#search-button {\n  float: right;\n  margin-right: 0.5rem; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/secure/ride/ride.component.ts":
/*!***********************************************!*\
  !*** ./src/app/secure/ride/ride.component.ts ***!
  \***********************************************/
...
var RideComponent = /** @class */ (function () {
    function RideComponent(provider) {
        this.provider = provider;
        this.person = {};
        this.candidates = [];
        this.currentPerson = {};
    ...
    RideComponent.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        modalElem = $('.modal').modal();
                        this.modalRef = materialize_css__WEBPACK_IMPORTED_MODULE_3__["Modal"].getInstance(modalElem);
                        _a = this;
                        return [4 /*yield*/, this.provider.getAccount()];
                    case 1:
                        _a.person = _c.sent();
                        _b = this;
                        return [4 /*yield*/, this.provider.getAccounts()];
                    case 2:
                        _b.candidates = _c.sent();
                        console.log('users', this.candidates);
                        this.candidates = this.candidates.filter(function (c) { return c._id != _this.person._id; });
                        this.candidates = this.candidates.filter(function (c) { return c.lat && c.lng; });
                        this.candidates = this.candidates.filter(function (c) { return !_this.person.matches.map(function (m) { return m._id; }).includes(c._id); });
                        this.candidates = this.candidates.filter(function (c) { return !_this.person.invites.map(function (m) { return m._id; }).includes(c._id); });
                        this.candidates = this.candidates.filter(function (c) { return c.period == _this.person.period; });
                        this.candidates = this.candidates.filter(function (c) { return c.type != _this.person.type; });
    ...
    RideComponent.prototype.searchRides = function () {
        var _this = this;
        this.currentPerson = this.person;
        this.modalRef.open();
        setTimeout(function () { return _this.agmMap.triggerResize(); }, 4000);
    };
    RideComponent.prototype.nextCandidate = function () {
        ...
        if (this.currentPerson._id) {
            ...
            materialize_css__WEBPACK_IMPORTED_MODULE_3__["toast"]({ html: 'Você já viu todos os usuários!' });
        }
    };
    RideComponent.prototype.refuse = function (person) {
        var _this = this;
        this.modalRef.close();
        setTimeout(function () { return _this.nextCandidate(); }, 300);
    };
    RideComponent.prototype.accept = function (person) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var personMatch, myMatch, invite;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!person.invites.map(function (i) { return i._id; }).includes(this.person._id)) return [3 /*break*/, 3];
                        person.invites = person.invites.filter(function (i) { return i._id != _this.person._id; });
                        personMatch = {
                        ...
                        return [4 /*yield*/, this.provider.updateAccount(this.person)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.provider.updateAccount(person)];
                    case 2:
                        _a.sent();
                        materialize_css__WEBPACK_IMPORTED_MODULE_3__["toast"]({ html: 'Nova carona cadastrada!' });
                        return [3 /*break*/, 5];
                    case 3:
                        invite = {
                            name: person.firstName,
    ...
    RideComponent.prototype.removeMatch = function (match) {
        this.person.matches = this.person.matches.filter(function (i) { return i != match; });
        this.provider.updateAccount(this.person);
    };
    RideComponent.prototype.removeInvite = function (invite) {
        this.person.invites = this.person.invites.filter(function (i) { return i != invite; });
        this.provider.updateAccount(this.person);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    ], RideComponent.prototype, "agmMap", void 0);
    RideComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-ride',
            template: __webpack_require__(/*! ./ride.component.html */ "./src/app/secure/ride/ride.component.html"),
            styles: [__webpack_require__(/*! ./ride.component.scss */ "./src/app/secure/ride/ride.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_providers_account_service__WEBPACK_IMPORTED_MODULE_4__["AccountService"]])
    ], RideComponent);
...
/* harmony import */ var _secure_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./secure.component */ "./src/app/secure/secure.component.ts");
/* harmony import */ var _ride_ride_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ride/ride.component */ "./src/app/secure/ride/ride.component.ts");
/* harmony import */ var _map_map_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./map/map.component */ "./src/app/secure/map/map.component.ts");
...
var routes = [{
        path: '',
        component: _secure_component__WEBPACK_IMPORTED_MODULE_3__["SecureComponent"],
        children: [
            { path: 'rides', component: _ride_ride_component__WEBPACK_IMPORTED_MODULE_4__["RideComponent"] },
...
var SecureRoutingModule = /** @class */ (function () {
    ...
    SecureRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = "\n  <main style=\"min-height: 100%\">\n    <nav class=\"teal lighten-1\" role=\"navigation\">\n      <div class=\"nav-wrapper container\">\n        <a id=\"main-header\" href=\"#\">Carenga<span class=\"hide-on-med-and-down\"> - {{ username }}</span></a>\n        <ul class=\"right hide-on-med-and-down\">\n          <li><a routerLink=\"#\" (click)=\"signOut()\">Logoff</a></li>\n        </ul>\n        <ul class=\"right hide-on-med-and-down\">\n          <li><a routerLink=\"rides\">Caronas</a></li>\n        </ul>\n        <ul class=\"right hide-on-med-and-down\">\n          <li><a routerLink=\"map\">Mapa</a></li>\n        </ul>\n  \n        <ul id=\"nav-mobile\" class=\"sidenav\">\n          <li class=\"teal lighten-1 white-text\"><a href=\"#\">Menu</a></li>\n          <li><a routerLink=\"map\" (click)=\"toggleMenu()\">Mapa</a></li>\n          <li><a routerLink=\"rides\" (click)=\"toggleMenu()\">Caronas</a></li>\n          <li><a routerLink=\"#\" (click)=\"signOut();toggleMenu()\">Logoff</a></li>\n        </ul>\n        <a (click)=\"toggleMenu()\" data-target=\"nav-mobile\" class=\"sidenav-trigger\"><i class=\"material-icons\">menu</i></a>\n      </div>\n    </nav>\n  \n      <router-outlet></router-outlet>\n      \n  </main>\n  "

/***/ }),

/***/ "./src/app/secure/secure.component.scss":
/*!**********************************************!*\
  !*** ./src/app/secure/secure.component.scss ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = "#main-header {\n  font-size: 28px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SecureComponent = /** @class */ (function () {
    ...
    SecureComponent.prototype.toggleMenu = function () {
        this.sidenavRef.isOpen ? this.sidenavRef.close() : this.sidenavRef.open();
    };
    SecureComponent.prototype.signOut = function () {
    ...
    SecureComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./secure.component.html */ "./src/app/secure/secure.component.html"),
            styles: [__webpack_require__(/*! ./secure.component.scss */ "./src/app/secure/secure.component.scss")]
        }),
...
/* harmony import */ var _secure_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./secure-routing.module */ "./src/app/secure/secure-routing.module.ts");
/* harmony import */ var _secure_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./secure.component */ "./src/app/secure/secure.component.ts");
/* harmony import */ var _ride_ride_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ride/ride.component */ "./src/app/secure/ride/ride.component.ts");
/* harmony import */ var _map_map_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./map/map.component */ "./src/app/secure/map/map.component.ts");
/* harmony import */ var _providers_account_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./providers/account.service */ "./src/app/secure/providers/account.service.ts");
...
var SecureModule = /** @class */ (function () {
    ...
    SecureModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                _secure_component__WEBPACK_IMPORTED_MODULE_6__["SecureComponent"],
                _map_map_component__WEBPACK_IMPORTED_MODULE_8__["MapComponent"],
                _ride_ride_component__WEBPACK_IMPORTED_MODULE_7__["RideComponent"]
            ],
            imports: [
            ...
            providers: [_providers_account_service__WEBPACK_IMPORTED_MODULE_9__["AccountService"]]
        })
    ], SecureModule);
    return SecureModule;
}());
...
//# sourceMappingURL=src-app-secure-secure-module.js.map